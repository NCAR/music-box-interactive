...
function AboutPage({ onNavigate }) {
  ...
  const sponsors = [
    { name: 'National Science Foundation', logo: '/logos/NSF.png', desc: 'Award NSF-AGS 19 41110' },
    {
      ...
      logo: '/logos/NCAR.avif',
      desc: 'MUSICA & MICM Development',
    },
    {
    ...
    },
    {
      ...
      desc: 'CAMP Co-Development & PartMC Integration',
    },
    {
      name: 'Texas A&M University',
      logo: '/logos/TAMU.JPEG',
      desc: 'MusicBox Interactive Desktop Development',
    },
    {
    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="flex justify-between h-14 sm:h-16">
            ...
            <div className="flex items-center space-x-2 xs:space-x-4 sm:space-x-6 md:space-x-8">
              <button
                ...
                className="text-[#141E30] hover:text-[#35577D] font-bold text-xs xs:text-sm sm:text-base"
              >
                Home
              </button>
              <button
        ...
        <div className="max-w-7xl mx-auto px-2 xs:px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 xs:gap-8 sm:gap-10 md:gap-12 items-center">
            ...
            <div>
              ...
              <div className="space-y-2 xs:space-y-3 sm:space-y-4 text-blue-50">
                <p className="leading-relaxed text-xs xs:text-sm sm:text-base">
                  ...
                  to let you build the chemical sysem you want. You can simulate that system for the
                  conditions you're interested in, and evaluate the results.
                  <br />
                  When you're ready, communicate your new chemical system to the community, so it
                  can run in any perticipatring model.
                </p>
                <Button
                  size="lg"
            ...
            <div className="flex items-center justify-center">
              <div
                className="relative w-48 h-48 xs:w-56 xs:h-56 sm:w-64 sm:h-64 md:w-72 md:h-72 lg:w-80 lg:h-80"
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center z-20">
                  <div
                    ...
                    style={{
                      background:
                        'radial-gradient(circle at 35% 35%, #fef3c7, #fbbf24, #f59e0b, #d97706, #92400e)',
                      boxShadow: `
      ...
      <div className="bg-gradient-to-br from-[#141E30] via-[#1f2f45] to-[#35577D] py-8 xs:py-12 sm:py-16 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-2 xs:px-4 sm:px-6 lg:px-8 relative z-10">
          <h2 className="text-2xl xs:text-3xl sm:text-4xl font-bold text-center mb-2 xs:mb-3 sm:mb-4 text-white">
            Behind the Music
          </h2>
          <p className="text-center text-gray-300 mb-8 xs:mb-12 sm:mb-16 text-sm xs:text-base sm:text-lg">
            Powered by cutting-edge atmospheric chemistry frameworks
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 xs:gap-8 sm:gap-10 mb-8 xs:mb-10 sm:mb-12">
              ...
              <div className="relative">
                ...
                <div className="p-4 xs:p-6 sm:p-8">
                  <p className="text-gray-300 mb-4 xs:mb-5 sm:mb-6 leading-relaxed text-xs xs:text-sm sm:text-base">
                    A run-time configured chemical system solver for gas- and condensed-phase
                    reactions. CAMP provides flexibility and performance for complex atmospheric
                  ...
                  <div className="bg-white/5 backdrop-blur-lg border border-white/20 p-2 xs:p-3 sm:p-4 rounded-lg mb-3 xs:mb-4">
                    <p className="text-xs xs:text-sm text-gray-300">
                      <strong className="text-white font-semibold">Developed by:</strong> Barcelona
                      Supercomputing Center (BSC) and University of Illinois
                    </p>
                  </div>
                  <Button
                    variant="secondary"
            ...
            <div className="group relative overflow-hidden rounded-xl xs:rounded-2xl backdrop-blur-xl bg-white/5 border border-white/20 shadow-2xl ">
              ...
              <div className="relative">
                ...
                <div className="p-4 xs:p-6 sm:p-8">
                  <p className="text-gray-300 mb-4 xs:mb-5 sm:mb-6 leading-relaxed text-xs xs:text-sm sm:text-base">
                    Designed to bring flexibility for chemical systems to high-performance weather
                    and climate models. MICM enables efficient chemistry integration across multiple
                    modeling platforms.
                  </p>
                  <div className="bg-white/5 backdrop-blur-lg border border-white/20 p-2 xs:p-3 sm:p-4 rounded-lg mb-3 xs:mb-4">
                    <p className="text-xs xs:text-sm text-gray-300">
                      <strong className="text-white font-semibold">Developed by:</strong> National
      ...
      <div className="bg-gradient-to-br from-[#141E30] via-[#1f2f45] to-[#35577D] py-8 xs:py-12 sm:py-16 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-2 xs:px-4 sm:px-6 lg:px-8 relative z-10">
          <h2 className="text-2xl xs:text-3xl font-bold text-center text-white mb-6 xs:mb-8 sm:mb-12">
            Overview
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 xs:gap-6 sm:gap-8">
            ...
            <div className="group relative overflow-hidden rounded-xl xs:rounded-2xl backdrop-blur-xl bg-white/5 border border-white/20 shadow-2xl hover:shadow-[#35577D]/60 p-4 xs:p-6 sm:p-8 transition-all duration-500 hover:scale-105">
              ...
              <div className="relative">
                <h3 className="text-xl xs:text-2xl sm:text-3xl font-bold mb-4 xs:mb-5 sm:mb-6 text-white">
                  MUSICA
                </h3>
                <div className="space-y-2 xs:space-y-3 sm:space-y-4 text-gray-300">
                  <p className="leading-relaxed text-xs xs:text-sm sm:text-base">
                    ...
                    Aerosols) at the National Center for Atmospheric Research's Atmospheric
                    Chemistry Observations and Modeling Laboratory.
                  </p>
                  <p className="leading-relaxed text-xs xs:text-sm sm:text-base">
                    MUSICA will become a computationally feasible global modeling framework that
                    allows for the simulation of large-scale atmospheric phenomena, while still
                    resolving chemistry at emission and exposure relevant scales (down to ~4 km
                    within the next 5 years).
                  </p>
                  <p className="leading-relaxed text-xs xs:text-sm sm:text-base">
                    The Model-Independent Chemistry Module (MICM) is also developed at NCAR-ACOM and
                    can bring MusicBox mechanisms you develop here to high-performance weather and
                    climate models.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-2 xs:space-y-3 sm:space-y-4">
              ...
              <div className="group relative overflow-hidden rounded-lg backdrop-blur-lg bg-white/5 border border-white/20 shadow-lg hover:shadow-[#35577D]/40 p-3 xs:p-4 sm:p-6 transition-all duration-300 hover:scale-105">
                ...
                <div className="relative">
                  <h4 className="text-base xs:text-lg sm:text-xl font-bold mb-2 xs:mb-3 text-white">
      ...
      <div className="bg-gradient-to-br from-[#141E30] via-[#1f2f45] to-[#35577D] py-8 xs:py-12 sm:py-16 overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-2 xs:px-4 sm:px-6 lg:px-8 relative z-10">
          <h2 className="text-2xl xs:text-3xl font-bold text-center mb-6 xs:mb-8 sm:mb-12 text-white">
          ...
          >
            ...
            {[...sponsors, ...sponsors, ...sponsors].map((sponsor, index) => (
              <div
                key={index}
                className="flex-shrink-0 w-36 xs:w-40 sm:w-48 text-center transition-opacity duration-700 ease-in-out"
              >
